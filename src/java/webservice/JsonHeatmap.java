...
/**
 * This is the web service for Json Heatmap
 * @author Eugene
 */
public class JsonHeatmap extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getMethod() != null && (request.getMethod().equals("GET"))) {
            ...
            HeatmapController hmc = new HeatmapController();
            LinkedHashMap<String, Object> heatmapResult = hmc.getHeatmap(floor, date, token, true);
            ...
            String prettyJsonString = jsonPrint.prettyPrint(heatmapResult);
